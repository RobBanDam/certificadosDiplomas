<!-- ########## START: LEFT PANEL ########## -->
<div class="br-logo"><a href="../../views/UsuHome/"><span>[</span>Empresa<span>]</span></a></div>
<div class="br-sideleft overflow-y-auto">
	<label class="sidebar-label pd-x-15 mg-t-20">Menú</label>
	<div class="br-sideleft-menu">
		<a href="../../views/UsuHome/" class="br-menu-link">
			<div class="br-menu-item">
				<i class="menu-item-icon icon ion-ios-home-outline tx-22"></i>
				<span class="menu-item-label">Inicio</span>
			</div><!-- menu-item -->
		</a><!-- br-menu-link -->
		<a href="../../views/UsuCurso/" class="br-menu-link">
			<div class="br-menu-item">
				<i class="menu-item-icon icon ion-ios-bookmarks-outline tx-20"></i>
				<span class="menu-item-label">Mis Cursos</span>
			</div><!-- menu-item -->
		</a><!-- br-menu-link -->
		<a href="../../views/UsuPerfil/" class="br-menu-link">
			<div class="br-menu-item">
